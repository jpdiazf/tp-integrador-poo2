...
class GestorDeReservasTest {
	...
	void testRecibimientoReservas() throws Exception{
		...
		//Preparaci�n Double del site
		when(sitioGestion.estaDadoDeAlta(casa)).thenReturn(true);
		//Preparaci�n Double del inmueble
	...
	void aprobacionORechazoReservas() throws Exception{
		...
		//Se verifica su aprobaci�n
		verify(reservaCasa, times(1)).aprobar();
		
		
		//APROBACI�N CON ERROR
	...
	void cancelacionReservas() throws Exception {
		...
		//la misma reserva se cancela y se delega el pago con su pol�tica de cancelaci�n correspondiente...
	...
	void consultasSobreReservas() throws Exception{
		...
		//y siguiendo con la misma l�gica, se agregan 2 reservas m�s...
		...
		//Tambi�n funciona con la reserva de un inmueble que no est� reservado.
